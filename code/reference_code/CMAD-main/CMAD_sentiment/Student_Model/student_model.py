...
from modality_drop import modality_drop
...
class StudentModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        coarse_l = texts.permute(0, 2, 1)# ori 2,0,1-->50,24,30
        coarse_l, x_a, x_v, p = modality_drop(coarse_l, acoustic, visual, self.p, self.args)
        ...
        coarse_a = proj_x_a.permute(0, 2, 1)# now 0,2,1-->24,50,30
